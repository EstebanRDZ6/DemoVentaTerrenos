...
class AppTheme {
  ...
  static ThemeData get lightTheme { final scheme = ColorScheme.fromSeed(seedColor: brand, brightness: Brightness.light).copyWith(primary: brand, secondary: accent, onPrimary: Colors.white); return _base(scheme, Brightness.light, Colors.white, lightSurface); }
  static ThemeData get darkTheme { final scheme = ColorScheme.fromSeed(seedColor: brand, brightness: Brightness.dark).copyWith(primary: const Color(0xFF69C7E7), secondary: const Color(0xFFFFC857), surface: const Color(0xFF121D24)); return _base(scheme, Brightness.dark, const Color(0xFF16232C), darkSurface); }

  static ThemeData _base(ColorScheme scheme, Brightness brightness, Color cardColor, Color scaffoldColor) => ThemeData(
    useMaterial3: true, brightness: brightness, colorScheme: scheme, scaffoldBackgroundColor: scaffoldColor, visualDensity: VisualDensity.adaptivePlatformDensity,
    ...
    inputDecorationTheme: InputDecorationTheme(filled: true, fillColor: brightness == Brightness.light ? Colors.white : const Color(0xFF17242C), contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14), border: OutlineInputBorder(borderRadius: BorderRadius.circular(15), borderSide: BorderSide(color: scheme.outlineVariant)), enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(15), borderSide: BorderSide(color: scheme.outlineVariant)), focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(15), borderSide: BorderSide(color: scheme.primary, width: 1.6))),
    ...
    textTheme: TextTheme(displaySmall: const TextStyle(fontSize: 40, fontWeight: FontWeight.w800, letterSpacing: -1.3), headlineMedium: const TextStyle(fontSize: 29, fontWeight: FontWeight.w800, letterSpacing: -.6), headlineSmall: const TextStyle(fontSize: 24, fontWeight: FontWeight.w700), titleLarge: const TextStyle(fontSize: 20, fontWeight: FontWeight.w700), titleMedium: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600), bodyLarge: TextStyle(fontSize: 16, height: 1.5, color: scheme.onSurface), bodyMedium: TextStyle(fontSize: 14, height: 1.45, color: scheme.onSurfaceVariant)),
  );
}
