    ...
    return ValueListenableBuilder<AppUser?>(
      ...
      builder: (BuildContext context, AppUser? user, Widget? child) {
        return ValueListenableBuilder<AppLanguage>(
          ...
          builder: (BuildContext context, AppLanguage language, Widget? localeChild) {
            return Material(
              color: Colors.white,
              child: SafeArea(
                bottom: false,
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          if (!compact) ...<Widget>[
                            ...
                            _NavItem(
                              label: 'Alquiler',
                              selected: currentRoute == AppRoutes.rentals,
                              onTap: onGoRentals,
                            ),
                            _NavItem(
                              label: 'Contacto',
                            ...
                            if (user?.canUseCrm == true)
                              _NavItem(label: 'CRM', selected: currentRoute == AppRoutes.crm, onTap: onGoCrm),
                            if (user?.canUseCrm == true)
                              _NavItem(
                                label: 'ERP',
                                selected: currentRoute == AppRoutes.erp,
                                onTap: onGoErp ?? () => Navigator.pushNamed(context, AppRoutes.erp),
                              ),
                          ],
                          ...
                          if (user == null)
                            ...
                            PopupMenuButton<String>(
                              ...
                              itemBuilder: (_) => <PopupMenuEntry<String>>[
                                ...
                                if (user.canUseCrm)
                                  const PopupMenuItem<String>(value: 'erp', child: Text('Abrir ERP')),
                                if (user.isOwner)
                                  const PopupMenuItem<String>(
                                    value: 'admin',
                          ...
                          if (compact)
                            PopupMenuButton<String>(
                              ...
                              itemBuilder: (_) => <PopupMenuEntry<String>>[
                                ...
                                if (user?.canUseCrm == true)
                                  const PopupMenuItem<String>(value: 'erp', child: Text('ERP')),
