...
class SiteHeader extends StatelessWidget {
  ...
  final String currentRoute; final VoidCallback onGoHome, onGoSales, onGoRentals, onGoContact, onGoLogin, onGoProfile, onGoCrm; final VoidCallback? onGoErp;
