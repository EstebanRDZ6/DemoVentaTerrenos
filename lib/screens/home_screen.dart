...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(body: ListView(children: [
    ...
    HeroSection(onGoSales: () => _go(context, AppRoutes.sales)), const SizedBox(height: 28), _quickActions(context), const SizedBox(height: 20), const Padding(padding: EdgeInsets.symmetric(horizontal: 20), child: CompanySection()), const SizedBox(height: 28), _businessValue(context), const SizedBox(height: 28), const SiteFooter(),
  ]));
